/**
 * @file trail_model.hpp
 * @brief Trail model responsibilities.
 *
 * @details This file defines trail model behavior for learned spatial
 ...
 * `include/semaforr/spatial/representations/trail_model.hpp`.
 */
#pragma once
